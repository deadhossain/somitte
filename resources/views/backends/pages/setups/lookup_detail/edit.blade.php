    ...
    <div class="card-block">
        <form id="second" action="{{route('lookup_detail.update', ['lookup_detail' => $lookupDetail->id])}}" method="post" novalidate="">
            ...
            <div class="form-group row @error('name') has-error @enderror">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" type="text" class="form-control" name="name" placeholder="Enter Lookup Name" value="{{ old('name')?:$lookupDetail->name }}">
            ...
            <div class="form-group row @error('udid') has-error @enderror">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" type="text" class="form-control" name="udid" placeholder="Enter Enter User Define Id" value="{{ old('udid')?:$lookupDetail->udid }}">
                    <span class="messages popover-valid">
                        @error('udid')
                            <i class="text-danger error icofont icofont-close-circled" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="{{$message}}"></i>
                        @enderror
            ...
            <div class="form-group row @error('value') has-error @enderror">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" type="text" class="form-control" name="value" placeholder="Enter Lookup value" value="{{ old('value')?:$lookupDetail->value }}">
                    <span class="messages popover-valid">
                        @error('value')
                            <i class="text-danger error icofont icofont-close-circled" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="{{$message}}"></i>
                        @enderror
            ...
            <div class="form-group row @error('remarks') has-error @enderror">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" type="text" class="form-control" name="remarks" placeholder="Enter Lookup Remarks" value="{{ old('remarks')?:$lookupDetail->remarks }}">
                    <span class="messages popover-valid">
                        @error('remarks')
                            <i class="text-danger error icofont icofont-close-circled" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="{{$message}}"></i>
                        @enderror
