<div class="dropdown-primary dropdown open">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdown-7" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
            <a href="{{route('lookup_details.edit',$lookupDetails->id)}}" class="dropdown-item waves-effect waves-light">
        ...
        <a href="#" class="dropdown-item waves-light waves-effect" onclick="$(this).find('form').submit()">
            <i class="ti-trash"></i>
            Delete
            <form action="{{ route('lookup_details.destroy', $lookupDetails->id) }}" method="POST">
