    ...
    <div class="card-block">
        <form id="second" action="{{route('user.update',$user->id)}}" method="post" novalidate="">
            ...
            <div class="form-group row @error('name') has-error @enderror">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" type="text" class="form-control" name="name" placeholder="Enter Username" value="{{ $user->name }}">
            ...
            <div class="form-group row @error('email') has-error @enderror">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" type="text" class="form-control" name="email" placeholder="Enter email id" value="{{ $user->email }}">
                    <span class="messages popover-valid">
                        @error('email')
                            <i class="text-danger error icofont icofont-close-circled" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="{{$message}}"></i>
                        @enderror
            ...
            <div class="form-group row @error('old_password') has-error @enderror">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" type="password" class="form-control" name="old_password" placeholder="Password input">
                    <span class="messages popover-valid">
                        @error('old_password')
                            <i class="text-danger error icofont icofont-close-circled" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="{{$message}}"></i>
                        @enderror
