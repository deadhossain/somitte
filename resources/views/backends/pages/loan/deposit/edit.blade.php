...
<div class="card">
    <div class="card-header">
        <h5>Edit Loan Deposit</h5>
    </div>
    <div class="card-block">
        <form action="{{route('loan_deposit.update',$deposit->encryptId)}}" method="post" novalidate="">
            @csrf
            @method('patch')
            <div class="form-group row @error('customer_id') has-error @enderror">
                ...
                <div class="col-sm-10">
                    ...
                    <input autocomplete="off" type="text" class="form-control" name="customer_name" value="{{ $deposit->loanAccount->customer->name }}" readonly>
            ...
            <div class="form-group row @error('customer_id') has-error @enderror">
                ...
                <div class="col-sm-10">
                    ...
                    <input autocomplete="off" type="text" class="form-control" name="scheme_name" value="{{ $deposit->loanAccount->loanScheme->name }}" readonly>
                    <span class="messages popover-valid">
                        @error('customer_id')
                            <i class="text-danger error icofont icofont-close-circled" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="{{$message}}"></i>
                        @enderror
            ...
            <div class="form-group row @error('account_no') has-error @enderror">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" type="text" class="form-control" name="account_no" value="{{ $deposit->loanAccount->account_no }}" readonly>
                    <span class="messages popover-valid">
                        @error('account_no')
                            <i class="text-danger error icofont icofont-close-circled" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="{{$message}}"></i>
                        @enderror
