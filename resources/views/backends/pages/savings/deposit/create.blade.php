    ...
    <div class="card-block">
        <form action="{{route('deposit.store',$account->encryptId)}}" method="post" novalidate="">
            ...
            <div class="form-group row  @error('deposit_amount') has-error @enderror">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" type="text" class="form-control autonumber" name="deposit_amount" placeholder="Enter First Deposit Amount" value="{{ $account->savingsScheme->amount }}">
                    <span class="messages popover-valid">
            ...
            <div class="form-group row  @error('late_fee') has-error @enderror">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" type="text" class="form-control autonumber" name="late_fee" placeholder="Enter Late Fee" latefee={{$account->savingsScheme->late_fee}}
                    value="@php
