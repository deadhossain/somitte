                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" type="file" class="form-control @error('image') form-control-danger @enderror" name="image" placeholder="Enter Customer image" value="{{ old('name') }}">
                                            <span class="messages popover-valid">
                                                @error('image')
                                                    <i class="text-danger error icofont icofont-close-circled" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="{{$message}}"></i>
                                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" type="file" class="form-control @error('image') form-control-danger @enderror" name="name" placeholder="Enter Customer Name" value="{{ old('image') }}">
