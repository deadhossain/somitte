            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea rows="5" name="remakrs" class="form-control @error('remarks') form-control-danger @enderror" placeholder="Enter Remarks">{{old('remarks')?:$customer->remarks}}</textarea>
                            <span class="messages popover-valid">
                                @error('remarks')
                                    <i class="text-danger error icofont icofont-close-circled" data-toggle="tooltip" data-placement="top" data-trigger="hover" title="" data-original-title="{{$message}}"></i>
                                @enderror
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <img style="width: 260px;height: 300px;margin: auto;" src="{{$customer->image_path}}" alt="customer-default-pic" class="img-thumbnail image-preview">
