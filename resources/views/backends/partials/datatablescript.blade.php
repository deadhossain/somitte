            ...
            },
            {
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        .css( 'font-size', '12pt' )
                        .prepend(
                            '<div><img src="{{asset('/images/app_logo.png')}}" height="70px" width="80%"></div>' +
...
// {{asset('/images/defaults/report_header_logo.jpg')}}
function normalDatatable(table){
    var title  = table.closest('.card').find('.table-card-header').find('h5').text();
    let thisTable = table.DataTable({
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        ...
                        .prepend(
                            ...
                            '<div><img src="{{asset('assets/images/app_logo.png')}}" ></div>' +
                                '<hr style="margin-top: 5px">'+
                            '<div style="text-align: left;"><h3> '+title+' </h3></div>'
                        );
                },
